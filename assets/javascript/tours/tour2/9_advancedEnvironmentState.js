const advancedEnvironmentState = `;;; SETUP PROCEDURE
extensions[fetch import-a]
to setup
  clear-all
  reset-ticks
  import-a:pcolors fetch:url (word "https://raw.githubusercontent.com/SantaFeInstitute/ABMA/master/ch1/ch1_map.png")
  create-turtles 20 [
    set size 2
    set shape "turtle"
    setxy (350 + random 5) (160 + random 5)
  ]
end
...
to reproduce
  let empty-patches neighbors with [pcolor != white and count turtles-here = 0]
